...
unsigned char get_var_menu_overlay();		                             //	actively overlay screen (notification, incoming call и т.д.)
unsigned char set_var_menu_overlay(unsigned char val);			         //	
		...
		void* get_ptr_temp_buf_2();                                      //	pointer to screen data (не lost when overlay appears)
